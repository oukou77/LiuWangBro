...
int start()
{
   ...
   {  
      ...
      if(hasPendingBuy== false) 
      {
         ...
         double buyStopPrice = NormalizeDouble(MathMax(MathMin(slowMA1,bbL2), buyOpenPrice-stopLossPoints*Point), Digits);
   ...
   {        
      ...
      if(hasPendingSell == false)
      {
         ...
         double sellStopPrice = NormalizeDouble(MathMin(MathMax(slowMA1,bbU2),sellOpenPrice+stopLossPoints*Point), Digits);
